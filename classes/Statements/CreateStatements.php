...
// varialbes utilisés pour instancier le statement XAPI 
    ...
    function __construct(){
        ...
        $this->urlStatement = "https://comper.fr/xapi"; // mettre la bonne url une fois le serveur XAPI installé
    ...
    public function sendStatements()
    {
        ...
        curl_setopt($curl, CURLOPT_POSTFIELDS, $this->statementJSON);
